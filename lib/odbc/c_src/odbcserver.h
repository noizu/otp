...
#ifndef __ODBCSERVER_H__
#define __ODBCSERVER_H__
...
/*!
 * Constants defining the command protocol between the Erlang control process
...
//---------------------------------------------------------
// Parameter Types Give to param_query
//---------------------------------------------------------
...
//---------------------------------------------------------
#ifdef WIN32
typedef SOCKET ERL_SOCKET;
#define __db_handle__ DWORD WINAPI
#else
typedef int ERL_SOCKET;
#define __db_handle__ void
#endif
...
//---------------------------------------------------------
// Macros | Mostly pointer field access wrappers.
//---------------------------------------------------------
...
#define extended_error(db_state, error_code) ( extended_errors(state) ? ((char *)error_code) : NULL )
